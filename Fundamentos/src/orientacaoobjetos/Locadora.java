...
public class Locadora {
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        System.out.println("O valor pra locacao do filme " + "simples é: " + valorLocacaoSimples);
        
        Cliente c2 = new Cliente("Marilza Sílva", "marilza@gmail.com");
        System.out.println(c2);
        
        double valorLocacaoLancamento = c2.calcularLocacao(3, true);
        System.out.println("O valor pra locação do filme " + "lançamento é: " + valorLocacaoLancamento);
